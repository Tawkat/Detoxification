...
def main():
    ...
    def preprocess_function(examples):
        ...
        outputs = []
        for tar,exp in zip(targets, explanations):
            ss = 'Detoxification: '+str(tar)+'\n'+'Explanation: '+str(exp)
            outputs.append(ss)
        labels = tokenizer(text_target=outputs, max_length=max_target_length, padding=padding, truncation=True)
